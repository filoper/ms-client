            ...
            ;
        {
            ...
            if (eequip) {
                ...
                switch (equipdata.get_reqstat(MapleStat::Id::JOB)) {
                    ...
                    case 1:
                        okjobs_preview.push_back(1);
                        canequip_preview[MapleStat::Id::JOB] =
                ...
                switch (prank_preview) {
                    case Equip::Potential::POT_HIDDEN:
                        potflag_preview = Text(Text::Font::A11M,
                    ...
                    case Equip::Potential::POT_LEGENDARY:
                        ...
                        break;
                    default: height_preview -= 16; break;
                }
                ...
                name_preview = Text(Text::Font::A12B,
                                    Text::Alignment::LEFT,
                                    namecolor,
                                    namestr,
                                    400);
                atkinc_preview = Text(Text::Font::A11M,
                ...
                if (hasdesc_preview) {
                    desc_preview = Text(Text::Font::A12M,
                                        Text::Alignment::LEFT,
                                        Color::Name::WHITE,
                                        desctext,
                                        250);
                ...
                category_preview = Text(Text::Font::A11M,
                                        Text::Alignment::LEFT,
                                        Color::Name::WHITE,
                ...
                if (hasslots_preview) {
                    ...
                    hammers_preview = Text(Text::Font::A11M,
                                           Text::Alignment::LEFT,
                                           Color::Name::WHITE,
    ...
    switch (equipdata.get_reqstat(MapleStat::Id::JOB)) {
        ...
        case 16:
            ...
            canequip[MapleStat::Id::JOB] =
                stats.get_stat(MapleStat::Id::JOB) / 100 == 5;
            break;
        default: canequip[MapleStat::Id::JOB] = false; break;
    }
...
void EquipTooltip::draw(Point<int16_t> pos) const {
    ...
    top.draw(pos);
    mid.draw(
        DrawArgument(pos + Point<int16_t>(0, 13), Point<int16_t>(0, height)));
    ...
    for (MapleStat::Id ms : requirements) {
        ...
        if (ms != MapleStat::Id::LEVEL)
            ...
            lvset[reqok].draw(reqstatstrings[ms],
                              6,
                              pos + reqpos + Point<int16_t>(54, 0));
    }
...
void EquipTooltip::draw_preview(Point<int16_t> pos) const {
    ...
    top.draw(pos);
    mid.draw(DrawArgument(pos + Point<int16_t>(0, 13),
                          Point<int16_t>(0, height_preview)));
    ...
    for (MapleStat::Id ms : requirements) {
        ...
        if (ms != MapleStat::Id::LEVEL)
            reqset[reqok].draw(reqstatstrings_preview[ms],
                               6,
                               pos + reqpos + Point<int16_t>(54, 0));
        else
            lvset[reqok].draw(reqstatstrings_preview[ms],
                              6,
                              pos + reqpos + Point<int16_t>(54, 0));
    }
