...
class Icon {
public:
    enum IconType : uint8_t { NONE, SKILL, EQUIP, ITEM, KEY, NUM_TYPES };
    ...
    public:
        ...
        virtual bool drop_on_items(InventoryType::Id tab,
                                   EquipSlot::Id eqslot,
                                   int16_t slot,
                                   bool equip) const = 0;

        virtual void drop_on_bindings(Point<int16_t> cursorposition,
                                      bool remove) const = 0;
