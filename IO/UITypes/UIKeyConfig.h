...
private:
    ...
    enum Buttons : uint16_t { CLOSE, CANCEL, DEFAULT, DELETE, KEYSETTING, OK };
    ...
    std::map<int32_t, Keyboard::Mapping> alternate_keys_ = {
        ...
        { KeyConfig::Key::HOME,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::PARTYCHAT) },
        { KeyConfig::Key::PAGE_UP,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::FRIENDSCHAT) },
        { KeyConfig::Key::T,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::BOSSPARTY) },
        { KeyConfig::Key::Y,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::ITEMPOT) },
        { KeyConfig::Key::U,
        ...
        { KeyConfig::Key::RIGHT_BRACKET,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::QUICKSLOTS) },
        { KeyConfig::Key::BACKSLASH,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::KEYBINDINGS) },
        { KeyConfig::Key::DELETE,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::GUILDCHAT) },
        { KeyConfig::Key::END,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::ALLIANCECHAT) },
        { KeyConfig::Key::G,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::GUILD) },
        { KeyConfig::Key::H,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::WHISPER) },
        { KeyConfig::Key::J,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::QUESTLOG) },
        { KeyConfig::Key::K,
        ...
        { KeyConfig::Key::APOSTROPHE,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::TOGGLECHAT) },
        { KeyConfig::Key::Z,
        ...
        { KeyConfig::Key::N,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::WORLDMAP) },
        { KeyConfig::Key::M,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::MINIMAP) },
    ...
    std::map<int32_t, Keyboard::Mapping> basic_keys_ = {
        ...
        { KeyConfig::Key::I,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::ITEMS) },
        { KeyConfig::Key::O,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::ENHANCEEQUIP) },
        { KeyConfig::Key::P,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::PARTY) },
        { KeyConfig::Key::LEFT_BRACKET,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::MENU) },
        ...
        { KeyConfig::Key::X,
          Keyboard::Mapping(KeyType::Id::ACTION, KeyAction::Id::SIT) },
        { KeyConfig::Key::C,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::MAPLECHAT) },
        { KeyConfig::Key::V,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::EVENT) },
        { KeyConfig::Key::B,
          Keyboard::Mapping(KeyType::Id::MENU, KeyAction::Id::PROFESSION) },
